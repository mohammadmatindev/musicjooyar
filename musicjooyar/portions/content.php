    <div class="container">
        <nav id="menu">
            ...
            <div class="menu-left">
                <a href="panel/login.php" class="btn btn-primary">
            ...
            <div class="music-cards">
                ...
                <a href="#" class="music-card">
                    <div class="card-thumbnail">
                        <img src="images/music-cover.jpg" alt="Music" width="400" height="400">
                        <span class="card-duration">04:18</span>
                    </div>
                    <div class="card-details">
                        <h3>عصر پاییزی</h3>
                        <div class="card-cols">
                            <div class="card-artist">
                                <img src="images/hamedmoody.jpg" alt="" width="24" height="24">
                                مرتضی پاشایی
                            </div>
                            <div class="card-date">
